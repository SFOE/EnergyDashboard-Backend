...
import { map, StromSparziel5ProzentPeakHSource } from '/opt/nodejs/models/strom-sparziel-5-prozent-peak-h.model';
import {
    deleteAllStromSparziel5ProzentPeakH,
    saveStromSparziel5ProzentPeakH
} from '/opt/nodejs/db/strom-sparziel-5-prozent-peak-h.db';
