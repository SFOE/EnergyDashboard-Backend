...
import {
    deleteAllGasSparzielAktuelleEinsparungV5,
    saveGasSparzielAktuelleEinsparungV5
} from '/opt/nodejs/db/gas/gas-sparziel-aktuelle-einsparung-v5.db';
import {
    map,
...
const gasSparzielAktuelleEinsparung = async () => {
    ...
    await deleteAllGasSparzielAktuelleEinsparungV5();
    await saveGasSparzielAktuelleEinsparungV5(data);
};
