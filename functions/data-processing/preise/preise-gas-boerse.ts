...
import { saveAllPreiseGasBoerse } from '/opt/nodejs/db/preise/preise-gas-boerse.db';
import {
    map,
    PreiseGasBoerseSource
} from '/opt/nodejs/models/preise/preise-gas-boerse.model';
