...
export interface StromVerbrauchLandesverbrauchVergleichV2 extends BaseModel, DateModel {
    id: string;
    date: string;
...
export const map = (records: StromVerbrauchLandesverbrauchVergleichSourceV2[]): StromVerbrauchLandesverbrauchVergleichV2[] => {
    return records.map(record => mapRecord(record));
}

const mapRecord = (record: StromVerbrauchLandesverbrauchVergleichSourceV2): StromVerbrauchLandesverbrauchVergleichV2 => ({
