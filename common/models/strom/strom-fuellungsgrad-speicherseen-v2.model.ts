...
export interface StromFuellungsgradSpeicherseenV2
    extends BaseModel,
        DateModel,
...
export const map = (
    records: StromFuellungsgradSpeicherseenSourceV2[]
): StromFuellungsgradSpeicherseenV2[] => {
    return records.map((record) => mapRecord(record));
};

const mapRecord = (
    record: StromFuellungsgradSpeicherseenSourceV2
): StromFuellungsgradSpeicherseenV2 => ({
    ...
    speicherstandBei100ProzentInGWh: parseFloatOrNullForNA(
        record.Speicherinhalt_100prozent_GWh
    ),
