...
export interface GasSparzielAktuelleEinsparung {
    id: string;
    monat: number;
    jahr: number;
...
export const map = (records: GasSparzielAktuelleEinsparungSource[]): GasSparzielAktuelleEinsparung[] => {
    return records.map(record => mapRecord(record));
}

export const mapRecord = (record: GasSparzielAktuelleEinsparungSource): GasSparzielAktuelleEinsparung => ({
